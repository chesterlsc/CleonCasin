...
- Brand the product and felt as `CLEON CASINO BLACKJACK` using the approved gold, platinum, and graphite C-and-crown emblem while preserving the graphite Carbon Club visual system. On mobile, use the approved full-width centered capsule: large emblem on the left, complete `CLEON CASINO` wordmark, `BLACKJACK` beneath it, and the three centered table-rule lines immediately below. Never reduce mobile felt branding to a small side emblem or compact corner lockup, and keep the complete composition clear of hands, wager circles, and controls.
- On mobile, give the felt the clear majority of the viewport. Keep the chip/deal dock short, place live Hit, Stand, Double, and Split decisions inside the lower table surface, and center the full CLEON capsule within the table with `BLACKJACK PAYS 3 TO 2` immediately below it.
